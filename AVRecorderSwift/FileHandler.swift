    ...
    func run () {
        ...
        while isRunning {
            ...
            autoreleasepool {
                ...
                let files = try! fileManager.contentsOfDirectory(atPath: stitchedPath as String)
            ...
            autoreleasepool {
                ...
                let files = try! fileManager.contentsOfDirectory(atPath: procPath as String)
            ...
            autoreleasepool {
                ...
                let files = try! fileManager.contentsOfDirectory(atPath: transPath as String)
